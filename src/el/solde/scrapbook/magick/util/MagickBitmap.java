...
import el.solde.scrapbook.magick.MagickException;
...
public class MagickBitmap {
	...
	public static Bitmap ToBitmap(MagickImage img) throws MagickException {
		...
		/*
		 * Because Java use big edian, when calling native bytesToInts, we must
		 * reverse the order of ARGB.
		 */
	...
	public static MagickImage fromBitmap(Bitmap bmp) throws MagickException {
		/*
		 * int width = bmp.getWidth(); int height = bmp.getHeight(); int count =
		 * width * height; int pixels[] = new int[count]; bmp.getPixels(pixels,
