...
public class Config2D888MSAA implements GLSurfaceView.EGLConfigChooser {
	...
	public EGLConfig chooseConfig(EGL10 egl, EGLDisplay display) {
		...
		if (numConfigs <= 0) { // Если подходящих кофигураций RGB888 нет, то
								// пробуем получить RGB888 или на худой конец
								// RGB565 без сглаживания
		...
		egl.eglChooseConfig(display, configSpec, configs, numConfigs, Value); // получаем
																				// массив
																				// конфигураций
